...
```{r, echo=FALSE}
newspapers <- read_dta("C:/Users/faria/OneDrive - University of Toronto/Masters of Information/Winter2020/INF2178/Problem Sets/problem set 4/Angelucci_Cage_AEJMicro_dataset.dta")
options(warn=-1)
```
